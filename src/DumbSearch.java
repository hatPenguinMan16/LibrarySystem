...
public class DumbSearch implements SearchMotor{
    ...
    public void serach() {
        ...
        System.out.println(this.bookList.get(0).getBorrowed());
        ...
        for (int idx = 0; idx < this.bookList.size(); idx++) {
            ...
            if (this.bookList.get(idx).getAuthor().replace("Author: ", "").equals(searchMsg)) System.out.println("working---------------------");
            if (this.bookList.get(idx).getLanguage().replace("Language: ", "").equals(searchMsg)) System.out.println("working---------------------");
            //if (this.bookList.get(idx).getPages().replace("Title: ", "").equals(searchMsg)) System.out.println("working---------------------");
            if (this.bookList.get(idx).getYear().replace("Year: ", "").equals(searchMsg)) System.out.println("working---------------------");
            if (this.bookList.get(idx).getIsbn().replace("ISBN: ", "").equals(searchMsg)) System.out.println("working---------------------");
            if (this.bookList.get(idx).getBorrowed().replace("Borrowed: ", "").equals(searchMsg)) System.out.println("working---------------------");
